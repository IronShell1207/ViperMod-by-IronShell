...
// Type: ViPER4WindowsBin.GlobalMessages
...
namespace ViPER4WindowsBin
{
    internal class GlobalMessages
    {
        ...
        public static string COPYRIGHT = "Copyright (C) 2020, vipercn.com. All rights reserved. Mod by IronShell from SΞVΞN mod." +
            " NON-Official";
        public static string SUPPORT_FORUM = "Website http://droidapps.cf";
