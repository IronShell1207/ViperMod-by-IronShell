...
// Type: ViPER4WindowsBin.UIControls.HSlider
    ...
    public class HSlider : UserControl
    {
        ...
        public uint Position
        {
            ...
            set
            {
                ...
                {
                    PositionChanged(Position / 100f, this);
                }
        ...
        private void HSlider_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (num > Width - Height / 2.0)
            {
                num = Width - Height / 2f;
            }

            m_nPosition = (uint)Math.Round((num - Height / 2f) / (Width - Height) * 100.0);
            if (PositionChanged != null)
            {
                PositionChanged(Position / 100f, this);
            }
